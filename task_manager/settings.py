...
PATH_VALID = 'django.contrib.auth.password_validation'
AUTH_PASSWORD_VALIDATORS = [
    {
        'NAME': f'{PATH_VALID}.UserAttributeSimilarityValidator',
    },
    {
        'NAME': f'{PATH_VALID}.MinimumLengthValidator',
    },
    {
        'NAME': f'{PATH_VALID}.CommonPasswordValidator',
    },
    {
        'NAME': f'{PATH_VALID}.NumericPasswordValidator',
    },
]
...
SPECTACULAR_SETTINGS = {
    ...
    Please create a new user and log in through basicAuth to be able to work with statuses, labels and tasks.''',
    'VERSION': '1.0.0',
